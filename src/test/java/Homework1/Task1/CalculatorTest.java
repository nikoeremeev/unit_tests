...
//         ).isInstanceOf(ArithmeticException.class);
        ...
        // Проверка на недопустимую скидку
//        assertThat(Calculator.calculatingDiscount(100,-5));
//        assertThat(Calculator.calculatingDiscount(100,1000));

        // Проверка  на недопустимую стоимость
//        assertThat(Calculator.calculatingDiscount(-50,5));
